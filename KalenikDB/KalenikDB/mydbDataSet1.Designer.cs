...
namespace KalenikDB {
    ...
    public partial class mydbDataSet1 : global::System.Data.DataSet {
        ...
        public partial class namesDataTable : global::System.Data.TypedTableBase<namesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public namesRow AddnamesRow(string Name, string Surname) {
        ...
        public partial class namesRow : global::System.Data.DataRow {
            ...
            public string Surname {
                get {
                    return ((string)(this[this.tablenames.SurnameColumn]));
                }
                set {
                    this[this.tablenames.SurnameColumn] = value;
                }
            }
        }
...
namespace KalenikDB.mydbDataSet1TableAdapters {
    ...
    public partial class namesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `names` WHERE ((`id` = @p1) AND (`Name` = @p2) AND (`Surname` = @p3))" +
                "";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `names` (`Name`, `Surname`) VALUES (@p1, @p2)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `names` SET `Name` = @p1, `Surname` = @p2 WHERE ((`id` = @p3) AND (`Name` " +
                "= @p4) AND (`Surname` = @p5))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::KalenikDB.Properties.Settings.Default.mydbConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `Name`, `Surname` FROM `names`";
        ...
        public virtual int Fill(mydbDataSet1.namesDataTable dataTable) {
        ...
        public virtual mydbDataSet1.namesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            mydbDataSet1.namesDataTable dataTable = new mydbDataSet1.namesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(mydbDataSet1.namesDataTable dataTable) {
